...
import AsciiAnimator from './AsciiAnimator.js';
import { MatrixFadeAnimator } from './MatrixFadeAnimator.js';

const ascii = getAscii(1);
const animator = new MatrixFadeAnimator(ascii);

// const animator = new AsciiAnimator(getAscii());
...
// Initialize animator with ASCII art
...
// Start animation with proper callback
